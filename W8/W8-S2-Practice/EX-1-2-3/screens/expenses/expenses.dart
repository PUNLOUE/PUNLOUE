...
class _ExpensesState extends State<Expenses> {
  ...
  // Variable to store the recently removed expense for the undo action
  Expense? _recentRemovedExpense;

  void onExpenseRemoved(Expense expense) {
    setState(() {
      _registeredExpenses.remove(expense);
      _recentRemovedExpense = expense;
    });
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          ...
          onPressed: () {
            setState(() {
              if (_recentRemovedExpense != null) {
                _registeredExpenses.add(_recentRemovedExpense!);
              }
            });
          },
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _registeredExpenses.isEmpty
          ? const Center(
              child: Text(
                'No expenses flound. Start adding some!',
